...
//         @Query() adminAdvertisingRevenueDetailQueryDTO: AdminAdvertisingRevenueDetailQueryDTO,
//         @Res() res: Response
//     ): Promise<any> {
//         let response: ResponseData = new ResponseData();

//         let time = new StoreProcedureGetTimeDatabase(adminAdvertisingRevenueDetailQueryDTO.report_type).getTimeType();
