...
export class AdminTopTenProductBestSellerDetailController{
    ...
    async spGRpAdminAdvertisingRevenue(
        @Query() adminTopTenProductBestSellerDetailQueryDTO: AdminTopTenProductBestSellerDetailQueryDTO,
        @Res() res: Response
    ): Promise<any> {
        ...
        let result: AdminTopTenProductBestSellerDetailDataModelEntity[] =
            await this.adminTopTenProductBestSellerDetailService.spGRpAdminTopTenProductBestSellerDetail(
                UtilsDate.formatDateInsertDatabase(adminTopTenProductBestSellerDetailQueryDTO.from_date),
                UtilsDate.formatDateInsertDatabase(adminTopTenProductBestSellerDetailQueryDTO.to_date),
