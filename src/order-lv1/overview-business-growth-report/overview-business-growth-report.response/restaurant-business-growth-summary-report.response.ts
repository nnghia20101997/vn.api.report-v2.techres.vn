...
export class RestaurantBusinessGrowthSummaryReportResponse{
    ...
    constructor(entity ?: RestaurantBusinessGrowthSummaryReportEntity){
     ...
     public mapToList(data: RestaurantBusinessGrowthSummaryReportEntity[]) {
      let response: RestaurantBusinessGrowthSummaryReportEntity[] = [];
      data.forEach((e) => {
        response.push(new RestaurantBusinessGrowthSummaryReportResponse(e));
      });
      return response;
    }
}