...
const admin_branch_report_response_1 = require("./admin-branch-report.response/admin-branch-report.response");
...
let AdminTopTenProductBestSellerDetailController = class AdminTopTenProductBestSellerDetailController {
    ...
    async spGRpAdminAdvertisingRevenue(adminBranchReportQueryDTO, res) {
        ...
        response.setData(new admin_branch_report_response_1.AdminBranchReportResponse().mapToList(result));
