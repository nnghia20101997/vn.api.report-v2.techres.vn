...
let AdminAdvertisingRevenueController = class AdminAdvertisingRevenueController {
    ...
    async spGRpAdminAdvertisingRevenue(adminAdvertisingRevenueQueryDTO, res) {
        ...
        let adminAdvertisingRevenue = await this.adminAdvertisingRevenueService.spGRpAdminAdvertisingRevenue(utils_format_time_common_1.UtilsDate.formatDateInsertDatabase(adminAdvertisingRevenueQueryDTO.from_date), utils_format_time_common_1.UtilsDate.formatDateInsertDatabase(adminAdvertisingRevenueQueryDTO.to_date), adminAdvertisingRevenueQueryDTO.report_type);
...
__decorate([
    ...
    __metadata("design:paramtypes", [admin_advertising_revenue_query_dto_1.AdminAdvertisingRevenueQueryDTO, Object]),
