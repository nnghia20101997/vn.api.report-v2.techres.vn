...
class ExceptionStoreProcedure {
    ...
    static validate(data) {
        if (data.length < 3 && (parseInt(data[1][0].status) === utils_store_procedure_status_enum_common_1.StoreProcedureStatusEnum.ERROR || parseInt(data[0][0].status) === utils_store_procedure_status_enum_common_1.StoreProcedureStatusEnum.FAIL_LOGIC)) {
    ...
    static validateEmptyDetail(data) {
        if (data.length < 3 && data[1][0].status != utils_store_procedure_status_enum_common_1.StoreProcedureStatusEnum.SUCCESS) {
