...
export declare class RestaurantRevenueCostCustomerByRestaurantBrandReportResponse {
    ...
    constructor(entity?: RestaurantRevenueCostCustomerByRestaurantBrandReportEntity);
}
