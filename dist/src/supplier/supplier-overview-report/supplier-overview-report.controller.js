...
const supplier_overview_report_query_dto_1 = require("./supplier-overview-report.dto/supplier-overview-report.query.dto");
...
let SupplierOverviewReportController = class SupplierOverviewReportController {
    ...
    async spGRpSupplierOverviewReport(supplierOverviewReportQueryDto, res) {
        ...
        let supplierOverviewReport = await this.supplierOverviewReportService.spGRpSupplierOverviewReport(supplierOverviewReportQueryDto.supplier_id, supplierOverviewReportQueryDto.restaurant_id, supplierOverviewReportQueryDto.branch_id, utils_format_time_common_1.UtilsDate.formatDateInsertDatabase(supplierOverviewReportQueryDto.from_date), utils_format_time_common_1.UtilsDate.formatDateInsertDatabase(supplierOverviewReportQueryDto.to_date));
...
__decorate([
    ...
    __metadata("design:paramtypes", [supplier_overview_report_query_dto_1.SupplierOverviewReportQueryDto, typeof (_a = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _a : Object]),
