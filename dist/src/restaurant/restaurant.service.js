...
let RestaurantService = class RestaurantService {
    ...
    async getListRestaurants(status) {
        ...
        utils_store_procedure_exception_common_1.ExceptionStoreProcedure.validate(restaurant);
        let data = new utils_store_procedure_result_common_1.StoreProcedureResult().getResultList(restaurant);
        return data;
    }
    async getDetailRestaurant(id) {
        ...
        utils_store_procedure_exception_common_1.ExceptionStoreProcedure.validate(restaurant);
        let data = new utils_store_procedure_result_common_1.StoreProcedureResult().getResultDetail(restaurant);
        return data;
    }
};
